...
BookList = ['The Museum Of Innocence','The Red Haired Woman','Animal Farm','Nineteen Eighty Four','A Momento For Istanbul'
,'A Tale Of Two Cities','The Green Mile','The Little Prince','White Fang','Lily Of The Valley'];
...
function renderList(array,className,linkList) {   
